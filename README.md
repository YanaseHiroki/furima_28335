...
出品した商品の画像が次の日以降も表示されるようにデータを保存します。
また、商品が購入されると取引ページに遷移できるように機能を追加しました。
...
詳細は[要件定義（バックログ）](https://docs.google.com/spreadsheets/d/1ZrZO1wQxSo14_JlXknruFUpz_g3t96uOgDhYvFn_8HY/edit?usp=sharing)をご覧ください！
